...
################################################################################
## Form generated from reading UI file 'ui_filebTyBkx.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.teachers_data = QWidget()
        self.teachers_data.setObjectName(u"teachers_data")
        self.gridLayout_14 = QGridLayout(self.teachers_data)
        self.gridLayout_14.setSpacing(0)
        self.gridLayout_14.setObjectName(u"gridLayout_14")
        self.gridLayout_14.setContentsMargins(0, 0, 0, 0)
        self.frame_2 = QFrame(self.teachers_data)
        ...
        self.stackedWidget.addWidget(self.teachers_data)
